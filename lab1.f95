PROGRAM MAIN
        ...
        DO FILL_LOOP_COUNTER=0, 100,1
            ...
            FACULTY_LIST(FILL_LOOP_COUNTER)%NEXT = -1
        end do
...
! start reading loops
	...
	200		FORMAT(A2)
			...
			! start if
			IF (COMMAND == "IN") THEN
				CALL INSERT_OP(INPUT_STRING, FACULTY_LIST, INDEX_LIST)
			ELSE IF (COMMAND == "DE") THEN
				CALL DELETE_OP(INPUT_STRING, FACULTY_LIST, INDEX_LIST)
			...
			ELSE IF (COMMAND == "PA") THEN
				CALL PRINT_ALL_OP(INPUT_STRING, FACULTY_LIST)
